...
func (p *PipelineService) ProdiPipeline(ctx context.Context) error {
	...
	if err := p.prodiRepository.BulkInsert(ctx, newProdi); err != nil {
		return err
	}
...
func (p *PipelineService) RespondenPipeline(ctx context.Context) error {
	...
	if err := p.respondenRepository.BulkInsert(ctx, newResponden); err != nil {
		return err
	}
...
func (p *PipelineService) UserStudyPipeline(ctx context.Context) error {
	...
	if err := p.userStudyRepository.BulkInsert(ctx, newUserStudy); err != nil {
		return err
	}
